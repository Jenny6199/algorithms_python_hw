...
# ВЫВОДЫ.
# На примере показана важность ассимптотической оценки сложности алгоритма.
# Для анализа использованы timeit, cProfile использование которых мы изучили на данном уроке
# и закрепили при выполнении домашнего задания.
# Большинство встроенных в язык программирования методов уже максимально оптимизированы.
# При написании собственного кода необходимо выполнять тестирование на предмет наличия
# 'бутылочного горлышка' которое замедляет работу алгоритма.
# Время выполнения алгоритма и количество памяти выделяемой при его реализации являются
# наиболее важными показателями которые, характеризуют качество данного алгоритма в целом.
