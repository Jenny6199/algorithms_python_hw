...
Задача №1. 1. Подсчитать, сколько было выделено памяти под переменные в ранее разработанных программах в рамках
первых трех уроков.
...
# "C:/Root/3379 Сапунов/Разное/Програмирование/GeekBrains/Python_alg_2/algorithms_python_hw/lesson_6/task_1.py"
