...
Студент: Максим Сапунов. Jenny6199@yandex.ru 17.07.2021

Задача №1. Написать программу, которая будет складывать, вычитать, умножать или делить два числа.
Числа и знак операции вводятся пользователем.
После выполнения вычисления программа не должна завершаться, а должна запрашивать новые
...
class Calculator:
    ...
    def __init__(self):
        ...
        self.digit_2 = None
        self.operator = None
        print('Запущена программа - калькулятор v.01 от 17.07.2021.')
